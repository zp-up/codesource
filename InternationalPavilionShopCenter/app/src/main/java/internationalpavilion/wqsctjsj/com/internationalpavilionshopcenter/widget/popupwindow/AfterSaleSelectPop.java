...
public class AfterSaleSelectPop implements View.OnClickListener {
    ...
    public AfterSaleSelectPop(Context c) {

        context = c;
        if (inflater == null) {
            inflater = LayoutInflater.from(context);
        }
        View v = inflater.inflate(R.layout.pop_after_sale_selected_layout, null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_close_select:
                ...
                break;
            case R.id.ll_to_back_all:
                if (click != null && pop != null){
                    click.onClick(1,0.0,0.0);
                    pop.dismiss();
                }
                break;
            case R.id.ll_change_goods:
                if (click != null && pop != null){
    ...
    void initView(View v) {
        llBackAll = v.findViewById(R.id.ll_to_back_all);
        llChangeGoods = v.findViewById(R.id.ll_change_goods);
        llBackMoney = v.findViewById(R.id.ll_back_money);
