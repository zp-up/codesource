...
public class LimitTimeGoodsFragment extends Fragment implements OnLimitTimeGoodsCallback {
    ...
    private static LimitTimeGoodsFragment INSTANCE;
    ...
    public static LimitTimeGoodsFragment getInstance(int startTime, int space, int currentPosition) {
        if (INSTANCE == null) {
            INSTANCE = new LimitTimeGoodsFragment();
        }
        LimitTimeGoodsFragment.startTime = startTime;
        LimitTimeGoodsFragment.space = space;
        LimitTimeGoodsFragment.currentPosition = currentPosition;
        return INSTANCE;
    }
