...
public class WaitReveivedOrderFragment extends Fragment implements OnCommonGoodsCallBack{
    private Unbinder unbinder;
    @BindView(R.id.rv_all_order)
    RecyclerView rvWaitReceived;
    ...
    public void onResume() {
        ...
        rvWaitReceived.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvWaitReceived.setAdapter(adapter);
        pageIndex = 1;
        initData();
    }
