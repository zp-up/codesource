...
public class WaitPayOrderFragment extends Fragment implements OnCommonGoodsCallBack{
    ...
    public void onResume() {
        ...
        rvWaitPay.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvWaitPay.setAdapter(adapter);
        pageIndex = 1;
        initData();
    }
