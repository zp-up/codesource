...
public class LimitTimeGoodsFragment_5 extends Fragment implements OnLimitTimeGoodsCallback {
    ...
    private static LimitTimeGoodsFragment_5 INSTANCE;
    ...
    public static LimitTimeGoodsFragment_5 getInstance(int startTime, int space, int currentPosition) {
        if (INSTANCE == null) {
            INSTANCE = new LimitTimeGoodsFragment_5();
        }
        LimitTimeGoodsFragment_5.startTime = startTime;
        LimitTimeGoodsFragment_5.space = space;
        LimitTimeGoodsFragment_5.currentPosition = currentPosition;
        return INSTANCE;
    }
