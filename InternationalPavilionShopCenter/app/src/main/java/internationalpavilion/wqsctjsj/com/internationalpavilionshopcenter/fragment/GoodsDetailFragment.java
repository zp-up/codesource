...
public class GoodsDetailFragment extends Fragment {
    ...
    private static GoodsDetailFragment instance;
    ...
    public static GoodsDetailFragment getInstance(ViewPager viewPager, String html) {
        instance = new GoodsDetailFragment();
