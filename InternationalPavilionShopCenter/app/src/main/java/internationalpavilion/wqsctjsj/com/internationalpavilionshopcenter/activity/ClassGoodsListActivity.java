...
public class ClassGoodsListActivity extends BaseAppcompatActivity implements OnBondedGoodsCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getIntExtra("classId", -1) != -1) {
...
//        bondedGoodsPresenter.getBrandData(paramsBrand, this);
            ...
            public void onClick(View v) {
                if (etMinPrice.getText().toString().trim().length() != 0 && etMaxPrice.getText().toString().trim().length() != 0) {
                    if (Integer.valueOf(etMinPrice.getText().toString().trim()) < Integer.valueOf(etMaxPrice.getText().toString().trim())) {
                        ...
                        ToastUtils.show(ClassGoodsListActivity.this, "最低价必须小于最高价");
                    }
                }
                pageIndex = 1;
                initData();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                ClassGoodsListActivity.this.finish();
                break;
    ...
    public int initLayout() {
        return R.layout.activity_class_goods_list;
    }
    ...
    public void onError(String error) {
        Log.e("ClassGoodsListActivity", "出错:" + error);
    }
                ...
                if (state == 0 && code == 0) {
                    if (jsonObject.has("data")) {
                        ...
                        if (pageIndex == 1) {
                            ...
                            ClassGoodsListActivity.this.data.clear();
