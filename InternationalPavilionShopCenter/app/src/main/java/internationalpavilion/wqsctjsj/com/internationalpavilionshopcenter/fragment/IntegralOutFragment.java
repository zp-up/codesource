...
public class IntegralOutFragment extends Fragment implements OnCommonGoodsCallBack{
            ...
            try {
                ...
                if (code == 0 && state == 0) {
                    if (jsonObject.has("data")) {
                        ...
                        if (pageIndex == 1) {
                            IntegralOutFragment.this.data.clear();
                            adapter.notifyDataSetChanged();
                        }
                        if (data != null && data.length() != 0) {
                            for (int i = 0; i < data.length(); i++) {
                                ...
                                IntegralOutFragment.this.data.add(inOrOutBean);
                            }
                        }
                        adapter.notifyDataSetChanged();
                    }
