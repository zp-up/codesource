...
public class LimitTimeGoodsFragment_3 extends Fragment implements OnLimitTimeGoodsCallback {
    ...
    private static LimitTimeGoodsFragment_3 INSTANCE;
    ...
    public static LimitTimeGoodsFragment_3 getInstance(int startTime, int space, int currentPosition) {
        if (INSTANCE == null) {
            INSTANCE = new LimitTimeGoodsFragment_3();
        }
        LimitTimeGoodsFragment_3.startTime = startTime;
        LimitTimeGoodsFragment_3.space = space;
        LimitTimeGoodsFragment_3.currentPosition = currentPosition;
        return INSTANCE;
    }
