...
public class LimitTimeGoodsFragment_2 extends Fragment implements OnLimitTimeGoodsCallback {
    ...
    private static LimitTimeGoodsFragment_2 INSTANCE;
    ...
    public static LimitTimeGoodsFragment_2 getInstance(int startTime, int space, int currentPosition) {
        if (INSTANCE == null) {
            INSTANCE = new LimitTimeGoodsFragment_2();
        }
        LimitTimeGoodsFragment_2.startTime = startTime;
        LimitTimeGoodsFragment_2.space = space;
        LimitTimeGoodsFragment_2.currentPosition = currentPosition;
        return INSTANCE;
    }
