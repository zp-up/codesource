...
public class GoodsInstructionsFragment extends Fragment {
    private Unbinder unbinder;
    private WebView webview;
    @BindView(R.id.ll_webView_container)
    LinearLayout llWebViewContent;
    private static GoodsInstructionsFragment instance;
    ...
    public static GoodsInstructionsFragment getInstance(ViewPager viewPager, String html) {
        instance = new GoodsInstructionsFragment();
