...
public class LimitTimeGoodsFragment_1 extends Fragment implements OnLimitTimeGoodsCallback {
    ...
    private static LimitTimeGoodsFragment_1 INSTANCE;
    ...
    public static LimitTimeGoodsFragment_1 getInstance(int startTime, int space, int currentPosition) {
        if (INSTANCE == null) {
            INSTANCE = new LimitTimeGoodsFragment_1();
        }
        LimitTimeGoodsFragment_1.startTime = startTime;
        LimitTimeGoodsFragment_1.space = space;
        LimitTimeGoodsFragment_1.currentPosition = currentPosition;
        return INSTANCE;
    }
