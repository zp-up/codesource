...
public final class StorageUtils {
    ...
    private static final String DIR_ROOT                    = "pelly";
     ...
     * Cache directory will be created on SD card <i>("/Android/data/[app_package_name]/cache/uil-images")</i>
    ...
    public static File getExternalCacheDir(Context context) {
        File dataDir     = new File(new File(Environment.getExternalStorageDirectory(), "iflow"), "data");
