...
public class WaitDeliveryOrderFragment extends Fragment implements OnCommonGoodsCallBack {
    private Unbinder unbinder;
    @BindView(R.id.rv_all_order)
    RecyclerView rvWaitDelivery;
    ...
    public void onResume() {
        ...
        rvWaitDelivery.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvWaitDelivery.setAdapter(adapter);
        pageIndex = 1;
        initData();
    }
    @Override
